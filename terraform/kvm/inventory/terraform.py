...
class TerraformResource(object):
    ...
    def is_ansible(self):
        ...
        return "libvirt_domain" in self.type()
...
class AnsibleInventory(object):
    ...
    def add_host_resource(self, resource):
        ...
        for network in resource.read_attr("network_interface"):
            hostname = network['hostname']
            ansible_host = {}
            ansible_host['ansible_host'] = network['addresses'][0]
